  ...
  function VehicleOfferDocument({ data, className = "" }, ref) {
    ...
    return (
      <div
        ...
        className={`bg-white text-slate-900 mx-auto w-full max-w-[760px] rounded-2xl border border-slate-200 p-6 sm:p-7 shadow-lg print:border-none print:shadow-none print:p-0 print:max-w-none print:w-full print:m-0 font-sans ${className}`}
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between border-b-2 border-slate-200 pb-4 gap-3">
          <div>
            <div className="flex items-center gap-3">
              <div className="flex size-10 items-center justify-center rounded-xl bg-emerald-600 text-white font-black text-lg shadow-sm">
